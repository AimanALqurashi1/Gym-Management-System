<aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-menu">
        <a href="{{ route('trainer.dashboard') }}"
            class="menu-item {{ request()->routeIs('trainer.dashboard') ? 'active' : '' }}" data-page="dashboard">
            <i class="fas fa-tachometer-alt"></i>
            <span class="menu-text">Dashboard</span>
        </a>

        <a href="{{ route('trainer.schedule') }}"
            class="menu-item {{ request()->routeIs('trainer.schedule') ? 'active' : '' }}" data-page="members">
            <i class="fas fa-calendar-alt"></i>
            <span class="menu-text">Schedule</span>
            <span class="menu-badge">5</span>
        </a>

        {{-- <a href="{{ route('trainer.class.details') }}"
            class="menu-item {{ request()->routeIs('trainer.class.details') ? 'active' : '' }}" data-page="classes">
 ...
 --}}
        <a href="{{ route('trainer.members') }}"
            class="menu-item {{ request()->routeIs('trainer.members') ? 'active' : '' }}" data-page="attendance">
            <i class="fas fa-users"></i>
            <span class="menu-text">Members</span>
        </a>

        <a href="{{ route('trainer.statistics') }}"
            class="menu-item {{ request()->routeIs('trainer.statistics') ? 'active' : '' }}" data-page="statistics">
