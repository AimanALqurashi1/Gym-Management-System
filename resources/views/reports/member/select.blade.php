{{-- resources/views/reports/member/select.blade.php --}}
@extends('layouts.home')

@section('title', 'Select Member for Attendance Report')
...
@section('content')
    <div class="select-container">
        <div class="select-card">
            ...
            <form action="{{ route('reports.member.attendance') }}" method="GET">
